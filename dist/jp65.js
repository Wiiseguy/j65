...
function matchAsm(asm, param) {
    ...
    if (param) {
        ...
        matched = j6502_instr_1.InstructionsArray.find(i => i.asm === asm && param.match(i.match));
    }
    else {
        matched = j6502_instr_1.InstructionsArray.find(i => i.asm === asm && i.match == null);
    }
    return matched;
}
...
class J6502_Parser {
    parse(lines) {
        const prg = new j6502_1.J6502_Program(); // TODO: determine size?
...
exports.J6502_Parser = J6502_Parser;

...
exports.J6502_NES_Emulator = void 0;
/*
...
const JM = jm65_1.J6502_Emulator;
function J6502_NES_Emulator() {
    this.load = function (buf) {
        let sb = new streambuf_1.default(buf);
        ...
        // RAM Memory mapping
        let zeroPage = new jm65_1.J6502_GenericStorage(0x100);
        ...
        let stack = new jm65_1.J6502_GenericStorage(0x100);
        ...
        let ram = new jm65_1.J6502_GenericStorage(0x600);
        ...
        let PPU = new jm65_1.J6502_GenericStorage(0x8);
        ...
        let APU = new jm65_1.J6502_GenericStorage(0x18);
        APU.connect(bus, 0x4000);
        let APU_IO = new jm65_1.J6502_GenericStorage(0x8); // APU and I/O functionality that is normally disabled
        APU_IO.connect(bus, 0x4018);
        // ROM Memory mapping
        let prgBank = new jm65_1.J6502_GenericROM(rom.buffer);
        ...
        for (let i = 0; i < 1; i++) {
            ...
            jm.run();
            jm.nmi();
            console.log('Heat:', (0, util_1.inspect)(jm.getHeatMap(), { maxArrayLength: null }));
        }
    ...
    this.loadFile = function (fileName) {
        let buf = (0, fs_1.readFileSync)(fileName);
        this.load(buf);
    };
    this.run = function () {
    };
...
exports.J6502_NES_Emulator = J6502_NES_Emulator;

...
exports.J6502_GenericStorage = exports.J6502_GenericROM = exports.J6502_MemoryBus = exports.J6502_Emulator = void 0;
/*
    6502 js emulator
...
const j6502_instr_1 = require("./j6502-instr");
const j6502_1 = require("./j6502");
 ...
 */
    ...
    function getNextInstr() {
        ...
        let instr = j6502_instr_1.InstructionsByOp[c];
...
exports.J6502_Emulator = J6502_Emulator;
J6502_Emulator.disassemble = function (prg, start = 0) {
    const program = new j6502_1.J6502_Program();
    const sb = new StreamBuffer(prg);
    sb.seek(start);
    while (!sb.isEOF()) {
        let op = sb.readByte();
        let instr = j6502_instr_1.InstructionsByOp[op];
        let data = null;
        if (instr) {
            if (instr.size === 2) {
                data = sb.readByte();
...
exports.J6502_MemoryBus = J6502_MemoryBus;
class J6502_GenericROM {
    #rom;
    constructor(buf) {
        if (!(buf instanceof Buffer))
            throw new Error("'buf' must be of type Buffer");
        this.#rom = buf;
    }
...
exports.J6502_GenericROM = J6502_GenericROM;
class J6502_GenericStorage {
    #ram;
    eventEmitter = new stream_1.EventEmitter();
    constructor(size = 0x2000) {
...
exports.J6502_GenericStorage = J6502_GenericStorage;
